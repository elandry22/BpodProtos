...
switch Action
    ...
    case 'update'
        ...
        if ~isempty(BpodSystem.Data.TrialTypes)
            ...
            if isfield(BpodSystem.Data.TrialSettings(TrialNum),'GUI') && ~isempty(BpodSystem.Data.TrialSettings(TrialNum).GUI) && isfield(BpodSystem.Data,'TrialTypes') 
...
if TrialNum>=Nrecent
    if sum(BpodSystem.Data.TrialData.NoResponse(TrialNum-(Nrecent-1):TrialNum)==0) > 0
