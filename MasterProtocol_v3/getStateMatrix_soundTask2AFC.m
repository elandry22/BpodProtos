...
outputs.DelayOutput = [];
% if params.giveStim
%     stimState = params.wav.stim.state{params.stimNum};
%     if strcmp(stimState, 'GoCue')
%         
%         outputs.CueOutput = [outputs.CueOutput, 'GlobalTimerTrig', 4];%, 'GlobalTimerTrig', 5, 'GlobalTimerTrig', 6];
%            
%     elseif strcmp(stimState, 'Delay')
%         
%         outputs.DelayOutput = {'GlobalTimerTrig', 4};%, 'GlobalTimerTrig', 5, 'GlobalTimerTrig', 6};
% 
%     end
% end
