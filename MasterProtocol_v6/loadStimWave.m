...
% to calibrate power/voltage curve
% use laserCalibration protocol and set output to 1 V
% put powermeter reading into scaling factor at end (X/6.02)
% where 6.02 was the power at 1V when curve was generated
...
% interp1 interpolates the power-voltage curve
% to give the voltage required to achieve powerOutput vector
