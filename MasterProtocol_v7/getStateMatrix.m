...
%         params.ITI = ITI;
    ...
    case 6 % Block Position
        
        [sma, TrialParams] = getStateMatrix_BlockPosition(TrialParams, TrialType, TrialNum);
        
    case 7 % Foraging
        [sma, TrialParams] = getStateMatrix_Foraging(TrialParams, TrialType, TrialNum);
end
