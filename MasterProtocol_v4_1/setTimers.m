...
elseif ~isempty(strfind(S.GUIMeta.Location.String{locationNum}, 'Box3'))
    
    if params.giveStim
%         wavIndex = params.stimNum;
        
        sma = SetGlobalTimer(sma, 'TimerID', 4, 'Duration', params.stimDur,...
            'OnsetDelay', params.stimDel, 'Channel', 'BNC2', ...
